	...
	<body>
		<nav class="navigation bg-dark">
			<div class="container">
		      ...
		      <h5 class="my-0 mr-md-auto font-weight-normal text-light">AutoParts Store</h5>
		      ...
		      <a class="btn btn-primary mr-2" href="cadastraProduto.php">Cadastrar Produto</a>
		      <a class="btn btn-danger" href="../controller/logout_controller.php" name="logout">Sair</a>
		    </div>
  		</div>
		</nav>
